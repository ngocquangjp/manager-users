...
//         functionality into a separate plugin for user who want just the
  ...
  function jq_param_sub( is_fragment, get_func, url, params, merge_mode ) {
    ...
    if ( params !== undefined ) {
      ...
      if ( merge_mode === 2 && is_string( params ) ) {
        ...
        // history user have requested this feature, it's only enabled for
...
//         window.onhashchange functionality into a separate plugin for user
